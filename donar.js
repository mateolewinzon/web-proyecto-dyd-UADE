const DONATION_OPTIONS = [
  {
    amount: 2000,
    description: 'Equivale a la plantación de 1 árbol nativo.',
    url: 'https://mpago.la/2f4xXLb',
  },
  {
    amount: 6500,
    description:
      'Equivale a 1 módulo de restauración plantado (1 m2 - 5 plantas).',
    url: 'https://mpago.la/2BBn5Fj',
  },
  {
    amount: 13000,
    description:
      'Equivale a 2 módulos de restauración plantados (2 m2 - 10 plantas).',
    url: 'https://mpago.la/1KNw8g8',
  },
  {
    amount: 32500,
    description: 'Equivale a 5 m2 restaurados (25 plantas).',
    url: 'https://mpago.la/2kejRZi',
  },
];
